...
print(f"\n✅ Uni‑LSTM Best Validation Accuracy: {best_val_acc:.4f}")
...
print("\n📊 Classification Report (Uni‑LSTM):")
...
plt.title("Uni‑LSTM Fine‑Tuned Confusion Matrix")
plt.tight_layout()
plt.savefig("uni_lstm_finetuned_cm.png")
plt.close()

print("✅ Confusion matrix saved as uni_lstm_finetuned_cm.png")

# =========================
# 6. Save model
# =========================
model.save("uni_lstm_finetuned.keras")
print("✅ Model saved as uni_lstm_finetuned.keras")

...
# =========================
# Bi-LSTM Fine‑Tuned Model
# =========================
print("📌 Building Bi-LSTM (Fine-tuned)...")
...
print("\n✅ Bi-LSTM (Fine-tuned) Classification Report:")
...
plt.title("Bi-LSTM Fine-tuned Confusion Matrix")
plt.savefig("bi_lstm_finetuned_cm.png")
plt.close()

# =========================
# Save Model
# =========================
model.save("bi_lstm_finetuned.keras")
print("✅ Model saved as bi_lstm_finetuned.keras")

del model
K.clear_session()
gc.collect()

print("\n🎉 Bi-LSTM Fine-tuning Completed Successfully!")
